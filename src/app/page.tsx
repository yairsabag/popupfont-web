      ...
      <section className="hero">
        <div className="hero-content">
          ...
          <div className="download-buttons">
            <a href="https://github.com/yairsabag/fontdrop-releases/releases/download/v1.0.6/FontDrop-1.0.6-Installer.dmg" className="download-btn">
            ...
            <a href="https://github.com/yairsabag/fontdrop-releases/releases/download/v1.0.6/FontDrop-1.0.6-Windows.zip" className="download-btn">
